...
class UIBuilder:
    ...
    def create_main_layout(self):
        ...
        # Filter frame
        filter_frame = [
            [sg.Text('Filters:', font=('Any', 12, 'bold'))],
            [sg.Text('', size=(25, 1)), sg.Checkbox('Exact', key='-EXACT-'), 
        ...
        # Top controls combining filters and sort/group
        top_controls = [
            [
                sg.Frame('', filter_frame, relief=sg.RELIEF_FLAT),
                sg.Frame('Sort and Group', sort_group_frame),
            ],
            [sg.Frame('Filter Controls', filter_controls)]
        ]
